      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-[#EAEAEA] pb-5">
        ...
        <div className="flex items-center gap-2.5">
          <button
            ...
            className="px-3.5 py-1.5 bg-white hover:bg-neutral-50 border border-[#EAEAEA] text-xs font-semibold rounded text-neutral-700 transition-colors cursor-pointer"
          >
            System Logs
          </button>
          <button
      ...
      {showBanner && hasUnresolvedAlerts && (
        <div className="bg-amber-50 border border-amber-200 rounded p-4 text-xs text-amber-900 flex gap-3 relative">
          ...
          <button 
            ...
            className="absolute top-3 right-3 text-amber-600 hover:text-amber-900 transition-colors cursor-pointer"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
                    ...
                    <td className="p-4 text-right">
                      <div className="inline-flex items-center gap-1.5">
                        <button
                          ...
                          className="px-2.5 py-1 hover:bg-neutral-100 border border-[#EAEAEA] rounded text-[11px] font-medium transition-colors flex items-center gap-1 cursor-pointer"
                        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="bg-white border border-[#EAEAEA] rounded-md p-5 shadow-sm lg:col-span-2 flex flex-col justify-between">
          ...
          <div className="border-t border-[#F5F5F5] pt-4 mt-4">
            <button
              onClick={() => onNavigate('/dashboard/logs')}
              className="text-xs font-bold text-neutral-800 hover:text-black font-mono uppercase tracking-wider flex items-center gap-1 hover:underline cursor-pointer"
            >
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-white border border-[#EAEAEA] rounded-md p-5 shadow-sm flex flex-col gap-4">
            ...
            <button
              ...
              className="w-full py-1.5 bg-neutral-50 hover:bg-neutral-100 text-neutral-700 border border-[#EAEAEA] text-xs font-semibold rounded transition-colors cursor-pointer"
            >
              Adjust Objectives
            </button>
          </div>
          ...
          <div className="bg-white border border-[#EAEAEA] rounded-md shadow-xl max-w-lg w-full overflow-hidden">
            ...
            <div className="bg-neutral-50 border-t border-[#EAEAEA] px-5 py-4 flex items-center justify-end gap-2">
              ...
              <button
                ...
                disabled={deploying}
                className="px-4 py-2 bg-black hover:bg-neutral-800 disabled:bg-neutral-200 text-white rounded text-xs font-semibold transition-colors cursor-pointer"
              >
